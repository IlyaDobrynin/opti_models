...
class SimpleBenchmark:
    ...
    def _make_dataloader(self, data_df: pd.DataFrame):
        dataset_obj = ImagenetDataset(data_df=data_df)
    ...
    def _compute_metrics(self, trues_df: pd.DataFrame, preds: t.Dict):
        ...
        logging.info(f"\t\tTOP 1 ACCURACY: {top_1_acc}")
        logging.info(f"\t\tTOP 5 ACCURACY: {top_5_acc}")
...
if __name__ == '__main__':
    ...
    bench_obj = SimpleBenchmark(model_name=model_name, max_batch_size=128, workers=11)
