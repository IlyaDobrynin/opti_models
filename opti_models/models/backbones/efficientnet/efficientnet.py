...
from ..utils.custom_blocks import round_channels, conv1x1_block, conv3x3_block, dwconv3x3_block, dwconv5x5_block, SEBlock
...
def efficientnet_b0(in_size=(224, 224), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b0", in_size=in_size, model_name="efficientnet_b0", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b1(in_size=(240, 240), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b1", in_size=in_size, model_name="efficientnet_b1", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b2(in_size=(260, 260), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b2", in_size=in_size, model_name="efficientnet_b2", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b3(in_size=(300, 300), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b3", in_size=in_size, model_name="efficientnet_b3", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b4(in_size=(380, 380), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b4", in_size=in_size, model_name="efficientnet_b4", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b5(in_size=(456, 456), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b5", in_size=in_size, model_name="efficientnet_b5", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b6(in_size=(528, 528), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b6", in_size=in_size, model_name="efficientnet_b6", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b7(in_size=(600, 600), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b7", in_size=in_size, model_name="efficientnet_b7", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b8(in_size=(672, 672), requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_efficientnet(version="b8", in_size=in_size, model_name="efficientnet_b8", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def efficientnet_b0b(in_size=(224, 224), requires_grad=True, **kwargs):
    """
...
def efficientnet_b1b(in_size=(240, 240), requires_grad=True, **kwargs):
    """
...
def efficientnet_b2b(in_size=(260, 260), requires_grad=True, **kwargs):
    """
...
def efficientnet_b3b(in_size=(300, 300), requires_grad=True, **kwargs):
    """
...
def efficientnet_b4b(in_size=(380, 380), requires_grad=True, **kwargs):
    """
...
def efficientnet_b5b(in_size=(456, 456), requires_grad=True, **kwargs):
    """
...
def efficientnet_b6b(in_size=(528, 528), requires_grad=True, **kwargs):
    """
...
def efficientnet_b7b(in_size=(600, 600), requires_grad=True, **kwargs):
    """
...
def efficientnet_b0c(in_size=(224, 224), requires_grad=True, **kwargs):
    """
...
def efficientnet_b1c(in_size=(240, 240), requires_grad=True, **kwargs):
    """
...
def efficientnet_b2c(in_size=(260, 260), requires_grad=True, **kwargs):
    """
...
def efficientnet_b3c(in_size=(300, 300), requires_grad=True, **kwargs):
    """
...
def efficientnet_b4c(in_size=(380, 380), requires_grad=True, **kwargs):
    """
...
def efficientnet_b5c(in_size=(456, 456), requires_grad=True, **kwargs):
    """
...
def efficientnet_b6c(in_size=(528, 528), requires_grad=True, **kwargs):
    """
...
def efficientnet_b7c(in_size=(600, 600), requires_grad=True, **kwargs):
    """
...
def efficientnet_b8c(in_size=(672, 672), requires_grad=True, **kwargs):
    """
