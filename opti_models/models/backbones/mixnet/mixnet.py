...
def mixnet_s(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mixnet(version="s", width_scale=1.0, model_name="mixnet_s", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mixnet_m(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mixnet(version="m", width_scale=1.0, model_name="mixnet_m", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mixnet_l(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mixnet(version="m", width_scale=1.3, model_name="mixnet_l", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net
