...
def mobilenetv2_w1(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv2(width_scale=1.0, model_name="mobilenetv2_w1", **kwargs)
...
def mobilenetv2_w3d4(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv2(width_scale=0.75, model_name="mobilenetv2_w3d4", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv2_wd2(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv2(width_scale=0.5, model_name="mobilenetv2_wd2", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
...
def mobilenetv2_wd4(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv2(width_scale=0.25, model_name="mobilenetv2_wd4", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
