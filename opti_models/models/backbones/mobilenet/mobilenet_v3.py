...
def mobilenetv3_small_w7d20(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="small", width_scale=0.35, model_name="mobilenetv3_small_w7d20", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_small_wd2(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="small", width_scale=0.5, model_name="mobilenetv3_small_wd2", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_small_w3d4(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="small", width_scale=0.75, model_name="mobilenetv3_small_w3d4", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_small_w1(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="small", width_scale=1.0, model_name="mobilenetv3_small_w1", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_small_w5d4(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="small", width_scale=1.25, model_name="mobilenetv3_small_w5d4", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_large_w7d20(requires_grad=True, **kwargs):
    """
    MobileNetV3 Small 224/0.35 model from 'Searching for MobileNetV3,' https://arxiv.org/abs/1905.02244.
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="large", width_scale=0.35, model_name="mobilenetv3_small_w7d20", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_large_wd2(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="large", width_scale=0.5, model_name="mobilenetv3_large_wd2", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_large_w3d4(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="large", width_scale=0.75, model_name="mobilenetv3_large_w3d4", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_large_w1(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="large", width_scale=1.0, model_name="mobilenetv3_large_w1", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net


def mobilenetv3_large_w5d4(requires_grad=True, **kwargs):
    """
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    net = get_mobilenetv3(version="large", width_scale=1.25, model_name="mobilenetv3_large_w5d4", **kwargs)
    for params in net.parameters():
        params.requires_grad = requires_grad
    return net
